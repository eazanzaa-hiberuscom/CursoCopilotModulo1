document.addEventListener("DOMContentLoaded", () => {
          ...
          ? details.participants
              .map(
                (participant) =>
                  ...
                  `<button class="participant-delete-button" data-activity="${encodeURIComponent(name)}" data-email="${encodeURIComponent(participant)}" aria-label="Unregister ${escapeHtml(participant)}" title="Unregister participant">` +
                  `🗑</button>` +
                  `</li>`
              )
              .join("")
  ...
  // Handle unregister action from participant list
